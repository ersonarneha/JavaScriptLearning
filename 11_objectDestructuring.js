const person = {
    ...
    let { pinCode, totalRun, city, isMarried, wifeName="Anushka",education} = person; // Object Destructuring
console.log(pinCode, totalRun, city, isMarried, wifeName,education );
