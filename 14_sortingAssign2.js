...
//   });
  console.log(`===============================Sorting array in ascending order of employee ID's===============================`);
  array_employees.sort((value1,value2)=>{
return value1.emp_id > value2.emp_id ? 1 : -1 ;
  });
  array_employees.forEach((currentValue)=>{
console.log(`ID:${currentValue.emp_id}, Name: ${currentValue.emp_name}, Dept: ${currentValue.emp_dept}`);
  });
...
console.log(`ID:${currentValue.emp_id}, Dept: ${currentValue.emp_dept}, Company: ${currentValue.emp_company}`);
  ...
  console.log(`=================================Sorting array in descending order of employee salary============================`);
  array_employees.sort((value1,value2)=>{
