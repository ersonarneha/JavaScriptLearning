...
console.log(`==========================================`);
//ony one argument current value is mandatory and other two are optional
arrayNumbers.forEach(function(currentValue){
    console.log(currentValue);
});
console.log(`================================================`);
//In short we can write using arrow function
arrayNumbers.forEach((currentValue)=>{
    console.log(currentValue);
});
console.log(`========================================================`);
//again more short in one lie
...
const arrayOfEven = [];
console.log(array);
array.forEach( (currentValue) => {if(currentValue%2==0) 
    {arrayOfEven.push(currentValue);console.log(currentValue);
    }
});
